...
function gnot(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
                Ptr{Int},
                cglobal((:gnot, LibPARI.PARI_jll.libpari)),
                1,
                reinterpret(Int, Ptr{Int}(_g1.ptr)),
                Int(0),
                Int(0),
                Int(0),
                Int(0),
...
function glength(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function gtranslength(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
"-_: negate argument"
function gneg(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gtocol0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gtocolrev0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gtolist(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
                Ptr{Int},
                ...
                reinterpret(
                    Int,
                    Ptr{Int}((_g1 === nothing ? C_NULL : _g1.ptr)),
                ),
                Int(0),
                Int(0),
                Int(0),
...
function gtomap(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gtomat(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gmodulo(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
            GC.@preserve _g1 _g2 LibPARI._trap_call(
                Ptr{Int},
                cglobal((:gmodulo, LibPARI.PARI_jll.libpari)),
                2,
                reinterpret(Int, Ptr{Int}(_g1.ptr)),
                reinterpret(Int, Ptr{Int}(_g2.ptr)),
                Int(0),
                Int(0),
                Int(0),
                Int(0),
...
function gtopoly(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gtopolyrev(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function Qfb0(
    x1::LibPARI.GenArg;
    x2::Union{Nothing,LibPARI.GenArg} = nothing,
    x3::Union{Nothing,LibPARI.GenArg} = nothing,
)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
            _g3 = x3 === nothing ? nothing : LibPARI.gen_convert(x3)
            GC.@preserve _g1 _g2 _g3 LibPARI._trap_call(
                Ptr{Int},
                ...
                reinterpret(
                    Int,
                    Ptr{Int}((_g2 === nothing ? C_NULL : _g2.ptr)),
                ),
                reinterpret(
                    Int,
                    Ptr{Int}((_g3 === nothing ? C_NULL : _g3.ptr)),
                ),
                Int(0),
                Int(0),
                Int(0),
...
function Ser0(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g3 = x3 === nothing ? nothing : LibPARI.gen_convert(x3)
            GC.@preserve _g1 _g3 LibPARI._trap_call(
                Ptr{Int},
...
function gtoset(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function pari_strchr(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gtovec0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gtovecrev0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gtovecsmall0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"[a..b] = [a,a+1,...,b]"
function vecrange(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gne(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gmode(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
        r = GC.@preserve _g1 LibPARI._trap_call(
            Ptr{Int},
...
function gmod(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function deriv(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"x': derivative of x with respect to the main variable."
function derivn(x1::LibPARI.GenArg, x2::Integer; x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"x*=y: shortcut for x=x*y."
function gmule(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function gmul(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
"x+=y: shortcut for x=x+y."
function gadde(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
"x+y: sum of x and y."
function gadd(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
"x-=y: shortcut for x=x-y."
function gsube(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function gsub(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
"_.a1"
function member_a1(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.a2"
function member_a2(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.a3"
function member_a3(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.a4"
function member_a4(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.a6"
function member_a6(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.area"
function member_area(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.b2"
function member_b2(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.b4"
function member_b4(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.b6"
function member_b6(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.b8"
function member_b8(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.bid"
function member_bid(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.bnf"
function member_bnf(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.c4"
function member_c4(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.c6"
function member_c6(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.clgp"
function member_clgp(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.codiff"
function member_codiff(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.cyc"
function member_cyc(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.diff"
function member_diff(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.disc"
function member_disc(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.e"
function member_e(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.eta"
function member_eta(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.f"
function member_f(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.fu"
function member_fu(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.gen"
function member_gen(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.group"
function member_group(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.index"
function member_index(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.j"
function member_j(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.mod"
function member_mod(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.nf"
function member_nf(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.no"
function member_no(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.normfu"
function member_normfu(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.omega"
function member_omega(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.orders"
function member_orders(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.p"
function member_p(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.pol"
function member_pol(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.polabs"
function member_polabs(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.r1"
function member_r1(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.r2"
function member_r2(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.reg"
function member_reg(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.roots"
function member_roots(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.sign"
function member_sign(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.t2"
function member_t2(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.tate"
function member_tate(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.tu"
function member_tu(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.zk"
function member_zk(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_.zkst"
function member_zkst(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"x/=y: shortcut for x=x/y."
function gdive(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function gdiv(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gshift(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gle(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function glt(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gidentical(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function geq(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gge(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
"x>>y: compute shift(x,-y)."
function gshift_right(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ggt(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function F2xq_log_Coppersmith_worker(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g3 = LibPARI.gen_convert(x3)
            _g4 = LibPARI.gen_convert(x4)
            GC.@preserve _g1 _g3 _g4 LibPARI._trap_call(
                Ptr{Int},
                cglobal((
                ...
                reinterpret(Int, Ptr{Int}(_g1.ptr)),
                Int(x2),
                reinterpret(Int, Ptr{Int}(_g3.ptr)),
                reinterpret(Int, Ptr{Int}(_g4.ptr)),
                Int(0),
                Int(0),
                Int(0),
                Int(0),
...
function Fp_log_sieve_worker(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g3 = LibPARI.gen_convert(x3)
            _g4 = LibPARI.gen_convert(x4)
            _g5 = LibPARI.gen_convert(x5)
            _g6 = LibPARI.gen_convert(x6)
            _g7 = LibPARI.gen_convert(x7)
            _g8 = LibPARI.gen_convert(x8)
            GC.@preserve _g3 _g4 _g5 _g6 _g7 _g8 LibPARI._trap_call(
                Ptr{Int},
                ...
                reinterpret(Int, Ptr{Int}(_g3.ptr)),
                reinterpret(Int, Ptr{Int}(_g4.ptr)),
                reinterpret(Int, Ptr{Int}(_g5.ptr)),
                reinterpret(Int, Ptr{Int}(_g6.ptr)),
                reinterpret(Int, Ptr{Int}(_g7.ptr)),
                reinterpret(Int, Ptr{Int}(_g8.ptr)),
            )
        end
    end
end
...
function QXQ_div_worker(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            ...
            _g3 = LibPARI.gen_convert(x3)
            _g4 = LibPARI.gen_convert(x4)
            GC.@preserve _g1 _g2 _g3 _g4 LibPARI._trap_call(
                Ptr{Int},
...
function RgM_ZM_mul_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
"worker for ZM_det"
function ZM_det_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
"worker for ZM_inv"
function ZM_inv_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
"worker for ZM_ker"
function ZM_ker_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
"worker for ZM_sqr"
function ZM_sqr_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ZXQX_resultant_worker(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            ...
            _g4 = LibPARI.gen_convert(x4)
            _g5 = LibPARI.gen_convert(x5)
            GC.@preserve _g1 _g2 _g3 _g4 _g5 LibPARI._trap_call(
                Ptr{Int},
...
"x[a..b] = [x[a],x[a+1],...,x[b]]"
function vecslice0(x1::LibPARI.GenArg, x3::Integer; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"x\\/=y: shortcut for x=x\\/y."
function gdivrounde(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function gdivround(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
"x\\=y: shortcut for x=x\\y."
function gdivente(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function gdivent(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gpowgs(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function aprcl_step4_worker(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            ...
            _g3 = LibPARI.gen_convert(x3)
            _g4 = LibPARI.gen_convert(x4)
            GC.@preserve _g2 _g3 _g4 LibPARI._trap_call(
                Ptr{Int},
...
function aprcl_step6_worker(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            ...
            _g4 = LibPARI.gen_convert(x4)
            _g5 = LibPARI.gen_convert(x5)
            GC.@preserve _g1 _g3 _g4 _g5 LibPARI._trap_call(
                Ptr{Int},
...
function chinese_unit_worker(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            ...
            _g5 = LibPARI.gen_convert(x5)
            _g6 = LibPARI.gen_convert(x6)
            GC.@preserve _g1 _g2 _g3 _g4 _g5 _g6 LibPARI._trap_call(
                Ptr{Int},
...
function dirartin_worker(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            ...
            _g5 = LibPARI.gen_convert(x5)
            _g6 = LibPARI.gen_convert(x6)
            GC.@preserve _g1 _g3 _g4 _g5 _g6 LibPARI._trap_call(
                Ptr{Int},
...
"ellan worker"
function direllnf_worker(x1::LibPARI.GenArg, x2::Integer, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g3 = LibPARI.gen_convert(x3)
...
"lfungenus2 worker"
function dirgenus2_worker(x1::LibPARI.GenArg, x2::Integer, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g3 = LibPARI.gen_convert(x3)
...
function ecpp_ispsp_worker(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function eval_mnemonic(x1::LibPARI.GenArg, x2::AbstractString)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
            GC.@preserve _g1 let _cs1 = Base.cconvert(Cstring, x2)
...
function factor_Aurifeuille(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function factor_Aurifeuille_prime(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ginv(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function lerch_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function lfuninit_theta2_worker(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            ...
            _g6 = LibPARI.gen_convert(x6)
            _g7 = LibPARI.gen_convert(x7)
            GC.@preserve _g2 _g3 _g4 _g5 _g6 _g7 LibPARI._trap_call(
                Ptr{Int},
...
function lfuninit_worker(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            ...
            _g7 = LibPARI.gen_convert(x7)
            _g8 = LibPARI.gen_convert(x8)
            _g9 = LibPARI.gen_convert(x9)
            GC.@preserve _g2 _g3 _g4 _g5 _g6 _g7 _g8 _g9 ccall(
...
function nflist_C3_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nflist_C5_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nflist_S3I_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nflist_S3R_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function parapply_slice_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function pareval_worker(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function parfor_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function parvector_worker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function polmodular_worker(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            ...
            _g8 = LibPARI.gen_convert(x8)
            _g9 = LibPARI.gen_convert(x9)
            _g10 = LibPARI.gen_convert(x10)
            _g11 = LibPARI.gen_convert(x11)
            GC.@preserve _g1 _g3 _g4 _g5 _g6 _g8 _g9 _g10 _g11 ccall(
...
function primecertisvalid_ecpp_worker(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_wrap_G (PARI)"
function gp_call(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"_wrap_GG (PARI)"
function gp_call2(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
"_wrap_bG (PARI)"
function gp_callbool(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
"_wrap_vG (PARI)"
function gp_callvoid(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
"x~: transpose of x."
function gtrans(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function addprimes(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algadd(
    x2::LibPARI.GenArg,
    x3::LibPARI.GenArg;
    x1::Union{Nothing,LibPARI.GenArg} = nothing,
)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
...
function algalgtobasis(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function algaut(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algb(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algbasis(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algbasistoalg(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function algcenter(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algchar(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algdegree(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function algdep0(x1::LibPARI.GenArg, x2::Integer; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algdim(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function algdisc(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function alggroupcenter(
    ...
    return LibPARI.protected_call() do
        ...
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
        r = GC.@preserve _g1 _g2 LibPARI._trap_call(
            Ptr{Int},
            cglobal((:alggroupcenter, LibPARI.PARI_jll.libpari)),
            3,
            reinterpret(Int, Ptr{Int}(_g1.ptr)),
            reinterpret(Int, Ptr{Int}((_g2 === nothing ? C_NULL : _g2.ptr))),
            reinterpret(Int, Base.unsafe_convert(Ptr{Ptr{Int}}, out1)),
            Int(0),
            Int(0),
            Int(0),
...
function alghassef(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function alghassei(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function alginv(x2::LibPARI.GenArg; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function alginvbasis(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algiscommutative(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function algisdivl(
    ...
    return LibPARI.protected_call() do
        ...
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
        r = GC.@preserve _g1 _g2 _g3 LibPARI._trap_call(
            Cint,
            cglobal((:algisdivl, LibPARI.PARI_jll.libpari)),
            4,
            reinterpret(Int, Ptr{Int}((_g1 === nothing ? C_NULL : _g1.ptr))),
            reinterpret(Int, Ptr{Int}(_g2.ptr)),
            reinterpret(Int, Ptr{Int}(_g3.ptr)),
            reinterpret(Int, Base.unsafe_convert(Ptr{Ptr{Int}}, out1)),
            Int(0),
...
function algissemisimple(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function algissimple(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function alglatadd(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        _g3 = LibPARI.gen_convert(x3)
...
function alglatindex(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function alglatinter(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        _g3 = LibPARI.gen_convert(x3)
...
function alglatmul(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function algmakeintegral(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algmultable(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algneg(x2::LibPARI.GenArg; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function algprimesubalg(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function alg_quotient(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function algradical(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algramifiedplaces(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algrelmultable(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algsimpledec(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algsplit(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algsplittingdata(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algsplittingfield(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algsqr(x2::LibPARI.GenArg; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function algsubalg(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function algtensor(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 3)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function algtype(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function gp_allocatemem(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    LibPARI.protected_call() do
        _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        GC.@preserve _g1 LibPARI._trap_call(
...
function apply0(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function arity0(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function bernpol_eval(x1::Integer; x2::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
            GC.@preserve _g2 LibPARI._trap_call(
                Ptr{Int},
...
function bestapprPade0(x1::LibPARI.GenArg; x2::Integer = -1, x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gcdext0(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bigomega(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function binaire(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gbitand(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gbitneg(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gbitnegimply(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gbitor(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gbittest(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gbitxor(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bnfcertify0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function decodemodule(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bnfisintnorm0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bnfisnorm(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bnfissunit(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bnflog(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bnflogef(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bnfnarrow(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function signunits(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function bnrclassnolist(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bnrcompositum(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bnrconductorofchar(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bnrgaloismatrix(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bnrinitmod(
    ...
    x2::LibPARI.GenArg;
    x3::Integer = 0,
    x4::Union{Nothing,LibPARI.GenArg} = nothing,
)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
            _g4 = x4 === nothing ? nothing : LibPARI.gen_convert(x4)
            GC.@preserve _g1 _g2 _g4 LibPARI._trap_call(
                Ptr{Int},
                ...
                reinterpret(
                    Int,
                    Ptr{Int}((_g4 === nothing ? C_NULL : _g4.ptr)),
                ),
                Int(0),
                Int(0),
                Int(0),
...
function bnrisgalois(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        _g3 = LibPARI.gen_convert(x3)
...
function bnrisprincipal(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function bnrmap(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function call0(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gceil(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function centerlift0(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function characteristic(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function charconj0(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function chardiv0(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function charker0(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function charmul0(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function charorder0(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function charpow0(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function cmp_universal(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function compo(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gconj(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function contfraceval(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function contfracinit(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function contfracpnqn(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function core0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function coredisc0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function dbgGEN(x1::LibPARI.GenArg; x2::Integer = -1)
    LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        GC.@preserve _g1 LibPARI._trap_call(
...
function digits(x1::LibPARI.GenArg; x2::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
...
function dirdiv(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function dirmul(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function dirzetak(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function divisors0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function divrem(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function elladd(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function akell(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellan(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellap(x1::LibPARI.GenArg; x2::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
...
function ellchangecurve(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellchangepoint(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellchangepointinv(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellconvertname(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function elldivpol(x1::LibPARI.GenArg, x2::Integer; x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellfromeqn(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellfromj(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellgenerators(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellglobalred(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellheegner(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellidentify(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellintegralmodel(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function elliscm(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function ellisisom(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellisogenyapply(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellisomat(x1::LibPARI.GenArg; x2::Integer = 0, x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellisoncurve(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellisotree(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellmaninconstant(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellminimaldisc(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellminimalmodel(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function ellminimaltwist0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellmoddegree(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellmul(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellneg(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellnonsingularmultiple(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellpadicfrobenius(x1::LibPARI.GenArg, x2::Integer, x3::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellpadicheight0(
    ...
    x3::Integer,
    x4::LibPARI.GenArg;
    x5::Union{Nothing,LibPARI.GenArg} = nothing,
)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
            _g4 = LibPARI.gen_convert(x4)
            _g5 = x5 === nothing ? nothing : LibPARI.gen_convert(x5)
            GC.@preserve _g1 _g2 _g4 _g5 LibPARI._trap_call(
                Ptr{Int},
                ...
                reinterpret(
                    Int,
                    Ptr{Int}((_g5 === nothing ? C_NULL : _g5.ptr)),
                ),
                Int(0),
                Int(0),
                Int(0),
...
function ellpadics2(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellratpoints(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellsea(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellsearch(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ellsub(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellsupersingularj(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function elltamagawa(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function elltaniyama(x1::LibPARI.GenArg; seriesprec::Integer = 16)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function elltors(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function elltrace(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ellweilcurve(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function ellxn(x1::LibPARI.GenArg, x2::Integer; x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function errname(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function eulerphi(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gpexponent(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function factmod(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function factorint(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function polfnf(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function factorpadic(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ffcompomap(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ffembed(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ffextend(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function fffrobenius(x1::LibPARI.GenArg; x2::Integer = 1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ffgen(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ffinit(x1::LibPARI.GenArg, x2::Integer; x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ffinvmap(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ffmap(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ffmaprel(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function ffnbirred0(x1::LibPARI.GenArg, x2::Integer; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ffprimroot(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function FFT(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function FFTinv(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gp_fileflush0(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    LibPARI.protected_call() do
        _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        GC.@preserve _g1 LibPARI._trap_call(
...
function gfloor(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function fold0(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gfrac(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function galoischardet(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function galoischarpoly(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function galoischartable(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function galoisconjclasses(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function galoisexport(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function galoisidentify(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function galoisisabelian(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function galoisisnormal(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function galoispermtopol(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function galoissubfields(x1::LibPARI.GenArg; x2::Integer = 0, x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function galoissubgroups(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ggcd0(x1::LibPARI.GenArg; x2::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
...
function gchar_conductor(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gcharduallog(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gcharisalgebraic(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        out1 = Ref{Ptr{Int}}(C_NULL)
...
function genus2igusa(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ghalfgcd(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function hammingweight(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function harmonic0(x1::Integer; x2::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
            GC.@preserve _g2 LibPARI._trap_call(
...
function hgmalpha(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function hgmcoef(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function hgmcoefs(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function hgmcyclo(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function hgmeulerfactor(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::Integer)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        out1 = Ref{Ptr{Int}}(C_NULL)
...
function hgmgamma(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function hgmissymmetrical(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function hgmparams(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function hgmtwist(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function hyperellchangecurve(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function hyperellcharpoly(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function hyperelldisc(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function hyperellisoncurve(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function hyperellordinate(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function hyperellpadicfrobenius0(
    x1::LibPARI.GenArg,
    x2::LibPARI.GenArg,
    x3::Integer,
)
...
function hyperellred(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function idealadd(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function idealappr0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function idealdown(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function idealinv(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function idealismaximal(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function idealispower(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::Integer)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        out1 = Ref{Ptr{Int}}(C_NULL)
...
function gideallist(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 4)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function idealnorm(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function idealnumden(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gpidealval(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gimag(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function integ(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function isfundamental(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function ispolygonal(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        out1 = Ref{Ptr{Int}}(C_NULL)
...
function ispowerful(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function gisprime(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function isprimepower(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function gispseudoprime(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function ispseudoprimepower(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function issquareall(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function issquarefree(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function istotient(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function kronecker(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function glcm0(x1::LibPARI.GenArg; x2::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
...
function lexcmp(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function lfuncreate(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function lfunetaquo(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function lfungenus2(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function lfunsympow(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function lift0(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function liftall(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function liftint(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function liftpol(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function lindep0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function localbitprec(x1::LibPARI.GenArg)
    LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        GC.@preserve _g1 LibPARI._trap_call(
...
function localprec(x1::LibPARI.GenArg)
    LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        GC.@preserve _g1 LibPARI._trap_call(
...
function logint0(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        out1 = Ref{Ptr{Int}}(C_NULL)
...
function mapget(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mapisdefined(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        out1 = Ref{Ptr{Int}}(C_NULL)
...
function matadjoint0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function matalgtobasis(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function matbasistoalg(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function matcompanion(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function matconcat(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function det0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function detint(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function matdetmod(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function diagonal(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function matfrobenius(x1::LibPARI.GenArg; x2::Integer = 0, x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function hess(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mathnf0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function hnfmod(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function hnfmodid(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mathouseholder(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function matimage0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function imagecompl(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function matimagemod(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        out1 = Ref{Ptr{Int}}(C_NULL)
...
function indexrank(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function intersect(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function inverseimage(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function matinvmod(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function isdiagonal(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function matker0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function matkerint0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function matkermod(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        out1 = Ref{Ptr{Int}}(C_NULL)
...
function matmuldiagonal(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function matmultodiagonal(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function matqpascal(x1::Integer; x2::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
            GC.@preserve _g2 LibPARI._trap_call(
...
function matpermanent(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function rank(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function matreduce(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function matsize(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function matsnf0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gauss(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function suppl(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gmax(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mfEH(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfTheta(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfatkin(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mfbasis(x1::LibPARI.GenArg; x2::Integer = 4)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfbd(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfbracket(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mfcoef(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfcoefs(x1::LibPARI.GenArg, x2::Integer; x3::Integer = 1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfconductor(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function mfcosets(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfcuspisregular(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function mfcusps(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfcuspwidth(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function mfderiv(x1::LibPARI.GenArg; x2::Integer = 1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfderivE2(x1::LibPARI.GenArg; x2::Integer = 1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfdescribe(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function mfdim(x1::LibPARI.GenArg; x2::Integer = 4)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfdiv(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mfeigenbasis(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfeisenstein(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
            _g3 = x3 === nothing ? nothing : LibPARI.gen_convert(x3)
            GC.@preserve _g2 _g3 LibPARI._trap_call(
                Ptr{Int},
...
function mffields(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mffromell(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mffrometaquo(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfhecke(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mfheckemat(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mfinit(x1::LibPARI.GenArg; x2::Integer = 4)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfisCM(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfisequal(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function mfisetaquo(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfkohnenbasis(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfkohnenbijection(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfkohneneigenbasis(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mflinear(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mfmul(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mfnumcusps(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfparams(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfpow(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfsearch(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 4)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mfshift(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfshimura(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mfsplit(x1::LibPARI.GenArg; x2::Integer = 0, x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mfsturm(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function mftobasis(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mftocoset(x1::Integer, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g2 = LibPARI.gen_convert(x2)
            _g3 = LibPARI.gen_convert(x3)
...
function mftonew(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mftraceform(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mftwist(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gmin(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function minpoly(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function modreverse(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function moebius(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function mscosets0(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mscuspidal(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function msdim(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function mseisenstein(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function msfarey0(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        out1 = Ref{Ptr{Int}}(C_NULL)
...
function msfromcusp(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function msfromell(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function msgetlevel(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function msgetsign(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function msgetweight(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function msinit(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function msissymbol(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function msnew(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function msomseval(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mspadicmoments(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mspadicseries(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mspathgens(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function mspathlog(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function mspolygon(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function msstar(x1::LibPARI.GenArg; x2::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
...
function mstooms(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function newtonpoly(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nextprime(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function algtobasis(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfbasis(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function basistoalg(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfcertify(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function nfdetint(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfdisc(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function nfdiscfactors(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function nfadd(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfdiv(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfdiveuc(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfdivrem(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfispower(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::Integer)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        out1 = Ref{Ptr{Int}}(C_NULL)
...
function nfissquare(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        out1 = Ref{Ptr{Int}}(C_NULL)
...
function nfmod(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfmul(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfnorm(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfpow(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfreduce(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nftrace(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gpnfvalrem(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        _g3 = LibPARI.gen_convert(x3)
...
function nffactor(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nffactormod(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function galoisapply(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfhnf0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfhnfmod(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function isideal(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function nfisincl0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfisisom(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfkermodpr(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfmodpr(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfmodprinit0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfmodprlift(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfresolvent(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function nfrootsof1(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function nfsnf0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function nfsubfields0(x1::LibPARI.GenArg; x2::Integer = 0, x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function nfsubfieldscm(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function nfsubfieldsmax(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"norm(x): norm of x."
function gnorm(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gnorml2(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function numbpart(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function numdiv(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function numtoperm(x1::Integer, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g2 = LibPARI.gen_convert(x2)
            GC.@preserve _g2 LibPARI._trap_call(
...
function omega(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function padicappr(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function padicfields0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gppadicprec(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function parapply(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function pareval(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function parselect(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function permcycles(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function permorder(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function permsign(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function permtonum(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function plotcolor(x1::Integer, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g2 = LibPARI.gen_convert(x2)
            GC.@preserve _g2 LibPARI._trap_call(
...
function plotcopy(
    ...
    LibPARI.protected_call() do
        ...
        _g4 = LibPARI.gen_convert(x4)
        av = LibPARI._avma()
        GC.@preserve _g3 _g4 LibPARI._trap_call(
            Cvoid,
...
function plotdraw(x1::LibPARI.GenArg; x2::Integer = 0)
    LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        GC.@preserve _g1 LibPARI._trap_call(
...
function plotexport(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function plothraw(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function plotmove(x1::Integer, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    LibPARI.protected_call() do
        _g2 = LibPARI.gen_convert(x2)
        _g3 = LibPARI.gen_convert(x3)
        av = LibPARI._avma()
...
function plotpoints(x1::Integer, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    LibPARI.protected_call() do
        _g2 = LibPARI.gen_convert(x2)
        _g3 = LibPARI.gen_convert(x3)
        av = LibPARI._avma()
...
function plotpointsize(x1::Integer, x2::LibPARI.GenArg)
    LibPARI.protected_call() do
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
        GC.@preserve _g2 LibPARI._trap_call(
...
function plotrecthraw(x1::Integer, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g2 = LibPARI.gen_convert(x2)
            GC.@preserve _g2 LibPARI._trap_call(
...
function plotrline(x1::Integer, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    LibPARI.protected_call() do
        _g2 = LibPARI.gen_convert(x2)
        _g3 = LibPARI.gen_convert(x3)
        av = LibPARI._avma()
...
function plotrmove(x1::Integer, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    LibPARI.protected_call() do
        _g2 = LibPARI.gen_convert(x2)
        _g3 = LibPARI.gen_convert(x3)
        av = LibPARI._avma()
...
function plotrpoint(x1::Integer, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    LibPARI.protected_call() do
        _g2 = LibPARI.gen_convert(x2)
        _g3 = LibPARI.gen_convert(x3)
        av = LibPARI._avma()
...
function plotscale(
    ...
    LibPARI.protected_call() do
        ...
        _g5 = LibPARI.gen_convert(x5)
        av = LibPARI._avma()
        GC.@preserve _g2 _g3 _g4 _g5 LibPARI._trap_call(
            Cvoid,
...
function polchebyshev_eval(
    ...
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g3 = x3 === nothing ? nothing : LibPARI.gen_convert(x3)
            GC.@preserve _g3 LibPARI._trap_call(
                Ptr{Int},
...
function polclass(x1::LibPARI.GenArg; x2::Integer = 0, x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function polcoef(x1::LibPARI.GenArg, x2::Integer; x3::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function polcompositum0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function polcyclo_eval(x1::Integer; x2::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
            GC.@preserve _g2 LibPARI._trap_call(
...
function polcyclofactors(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gppoldegree(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function poldisc0(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function poldiscfactors(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function reduceddiscsmith(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function polfromroots(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function polgraeffe(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function polint(
    ...
    return LibPARI.protected_call() do
        ...
        r = GC.@preserve _g1 _g2 _g3 LibPARI._trap_call(
            ...
            reinterpret(Int, Ptr{Int}(_g1.ptr)),
            reinterpret(Int, Ptr{Int}((_g2 === nothing ? C_NULL : _g2.ptr))),
            reinterpret(Int, Ptr{Int}((_g3 === nothing ? C_NULL : _g3.ptr))),
            reinterpret(Int, Base.unsafe_convert(Ptr{Ptr{Int}}, out1)),
            Int(0),
            Int(0),
            Int(0),
...
function polisclass(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function poliscyclo(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function poliscycloprod(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function polisirreducible(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function pollead(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function polrecip(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function polredabs0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function polredbest(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function polredord(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function polrootspadic(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function sylvestermatrix(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function polsym(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function polteichmuller(x1::LibPARI.GenArg, x2::Integer, x3::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function poltomonic(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function tschirnhaus(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function precprime(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function primecert0(x1::LibPARI.GenArg; x2::Integer = 0, x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function primecertexport(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function primecertisvalid(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function primepi(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function primes0(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function psdraw(x1::LibPARI.GenArg; x2::Integer = 0)
    LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        GC.@preserve _g1 LibPARI._trap_call(
...
function psplothraw(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function qfautoexport(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function qfbclassno0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function qfbcomp(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function qfbcompraw(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function qfbcornacchia(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function hclassno(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function nucomp(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function qfbpow(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function qfbpowraw(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function primeform(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function qfbsolve(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function qfgaussred0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function qflll0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function qflllgram0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function qfminimize(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function qfnorm(x1::LibPARI.GenArg; x2::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
...
function qforbits(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function qfparam(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function qfperfection(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function qfrep0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function qfsign(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function qfsolve(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function quaddisc(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function quadgen0(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function quadpoly0(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function quadunit0(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function quadunitindex(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function quadunitnorm(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function ramanujantau(x1::LibPARI.GenArg; x2::Integer = 12)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function genrand(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function greal(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function removeprimes(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function return0(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function rnfalgtobasis(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfbasis(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfbasistoalg(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfconductor0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfdet(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfdiscf(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfeltabstorel(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfeltdown0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfeltnorm(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfeltreltoabs(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfelttrace(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfeltup0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfequation0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfhnfbasis(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfidealabstorel(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfidealdown(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfidealfactor(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfidealhnf(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfidealmul(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfidealnormabs(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfidealnormrel(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfidealprimedec(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfidealtwoelement(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfidealup0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfinit0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfisabelian(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function rnfisfree(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function rnfislocalcyclo(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function rnfisnorm(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfisnorminit(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 2)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfnormgroup(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfpolredabs(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfpolredbest(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfpseudobasis(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function rnfsteinitz(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function round0(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function select0(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function seralgdep(x1::LibPARI.GenArg, x2::Integer, x3::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function serchop(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function convol(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function serdiffdep(x1::LibPARI.GenArg, x2::Integer, x3::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function laplace(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gpserprec(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function serreverse(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function setdelta(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function setintersect(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function setisset(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function setminus(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function setrand(x1::LibPARI.GenArg)
    LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        GC.@preserve _g1 LibPARI._trap_call(
...
function setsearch(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function setunion(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gmul2n(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function sumdivk(x1::LibPARI.GenArg; x2::Integer = 1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gsigne(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function simplify(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gsizebyte(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function sizedigit(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        av = LibPARI._avma()
        r = Int(
...
function gsqr(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function sqrtint0(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function sqrtnint(x1::LibPARI.GenArg, x2::Integer)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function subcyclopclgp(x1::LibPARI.GenArg, x2::LibPARI.GenArg; x3::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gsubst(x1::LibPARI.GenArg, x2::Integer, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g3 = LibPARI.gen_convert(x3)
...
function gsubstpol(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function gsubstvec(x1::LibPARI.GenArg, x2::LibPARI.GenArg, x3::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function sumdedekind(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function sumformal(x1::LibPARI.GenArg; x2::Integer = -1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function tayl(x1::LibPARI.GenArg, x2::Integer; seriesprec::Integer = 16)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
"trace(x): trace of x."
function gtrace(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function trunc0(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function type0(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gpolvar(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function variables_vec(; x1::Union{Nothing,LibPARI.GenArg} = nothing)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = x1 === nothing ? nothing : LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function vecmax0(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function vecmin0(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        out1 = Ref{Ptr{Int}}(C_NULL)
        av = LibPARI._avma()
...
function vecprod(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function vecsum(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function gpwritebin(
    ...
    LibPARI.protected_call() do
        _g2 = x2 === nothing ? nothing : LibPARI.gen_convert(x2)
        av = LibPARI._avma()
        GC.@preserve _g2 let _cs1 = Base.cconvert(Cstring, x1)
            GC.@preserve _cs1 LibPARI._trap_call(
                Cvoid,
...
function zetamultconvert(x1::LibPARI.GenArg; x2::Integer = 1)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function zetamultdual(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function znchar(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function zncharconductor(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function zncharisodd(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        av = LibPARI._avma()
...
function znchartoprimitive(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function znconreychar(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function znconreyconductor(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        _g1 = LibPARI.gen_convert(x1)
        _g2 = LibPARI.gen_convert(x2)
        out1 = Ref{Ptr{Int}}(C_NULL)
...
function znconreyexp(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function znconreylog(x1::LibPARI.GenArg, x2::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            _g2 = LibPARI.gen_convert(x2)
...
function znprimroot(x1::LibPARI.GenArg)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function znstar0(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
...
function znsubgroupgenerators(x1::LibPARI.GenArg; x2::Integer = 0)
    return LibPARI.protected_call() do
        LibPARI.gen_from() do
            _g1 = LibPARI.gen_convert(x1)
            GC.@preserve _g1 LibPARI._trap_call(
